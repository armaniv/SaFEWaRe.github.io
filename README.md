This document provides instructions about the [SaFEWaRe website](https://safeware.fbk.eu).
...
URL of the new page: `https://safeware.fbk.eu/complementary/[ConferenceAcronym][Year]`.
...
After this operation, the tool will be listed on the website (inside the [Events](https://safeware.fbk.eu/events) page).
...
URL of the new page: `https://safeware.fbk.eu/projects/[ProjectName]`.

The project will be automatically listed on the website (inside the [Projects](https://safeware.fbk.eu/projects) page).
...
URL of the new page: `https://safeware.fbk.eu/tools/[ToolName]`.
...
After this operation, the tool will be listed on the website (inside the [Tools](https://safeware.fbk.eu/tools) page).
